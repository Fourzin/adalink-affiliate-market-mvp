...
let WEBSITE, SCRIPT_ADDRESS, FEE_ADDRESS, SCRIPT_UTXO_REFERENCE,RSO_ADDRESS;
let NETWORK = 0; // 0 for testnet, 1 for mainnet
switch (NETWORK){
case 0: 
  WEBSITE = 'https://test-orderbook.adalink.io';
  SCRIPT_ADDRESS = 'addr_test1vrxn2jdmqyxf86cmdyf4qzn7cvmzcjce9c43zecs7u0472gsal7gw';//'';
