  ...
  return (
    <header className="header">
      <div className="logo">
        ...
        <div className='go-to-market-button' onClick={() => {window.location = "https://token-offerings-preview.adalink.io/"}}>
          Go to Token Offerings
        </div>
      </div>
      
      <nav className="nav">
        <ul className="nav-list">
          <li className="nav-item" id="nav-item-1" onClick={() => {selectedSPOID="0";document.getElementById("nav-item-1").style.fontWeight="bold";document.getElementById("nav-item-2").style.fontWeight="normal"}}>
            <Link to="/">Affiliate Programs</Link>
          </li>
          <li className="nav-item" id="nav-item-2" onClick={() => {selectedIPID="0";document.getElementById("nav-item-2").style.fontWeight="bold";document.getElementById("nav-item-1").style.fontWeight="normal"}} >
            <Link to="/spos">Explore Projects</Link>
          </li>
        </ul>
      </nav>
